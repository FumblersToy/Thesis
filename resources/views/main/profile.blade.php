...
<body class="min-h-screen relative overflow-x-hidden gradient-bg">
    ...
    return `/storage/${path}`;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Image modal handling is implemented in `resources/js/feed.js`.
            // Avoid duplicating modal code here to prevent conflicting handlers.
            ...
            // (Modal-related functions removed here; feed.js provides modal behavior.)
        });
    </script>
